...
d3.csv("assets/data/data.csv").then(function(censusData) {
    ...
    var xLinearScale = d3.scaleLinear()
      .domain([8, d3.max(censusData, d => d.poverty)])  // x LINEAR scale for scatter plots
      .range([0, width]);

    var yLinearScale = d3.scaleLinear()
      .domain([0, d3.max(censusData, d => d.healthcare)]) //y LINEAR scale for scatter plots
      .range([height, 0]);
    ...
    chartGroup.append("text")
      ...
      .attr("class", "aText") // aText is in css...us attribute fill to change color of text...example fill: #55aaf...no line breaking
